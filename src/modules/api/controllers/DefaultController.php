...
class DefaultController extends CommonController
{
    ...
    public function actionInitialize()
    {
        ...
        $model->polletId = Yii::$app->request->post('pollet_id');
        $model->uuid = Yii::$app->request->post('uuid');
        $model->platform = Yii::$app->request->post('platform');
        $model->device_token = Yii::$app->request->post('device_token');
